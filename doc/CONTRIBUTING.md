...
- git commit 时，建议带上 feat: fix: chores: docs:，等前缀标明本次 commit 的类型，遵循 [conventionalcommits](https://www.conventionalcommits.org/en/v1.0.0/) 的规范要求来做的话，自动发版才会正常工作。下面引用其中一段：
